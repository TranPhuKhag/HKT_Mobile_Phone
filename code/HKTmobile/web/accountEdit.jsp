...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .user-details-table input{width: 30rem;}
        </style>
    </head>
    <body>
                ...
                <div class="row">
                    <div class="col-md-12 user-details-section">
                        ...
                        <table class="user-details-table">
                            <tr><td>Full Name :</td><td><input type="text" name="name" value="${requestScope.object.fullname}"></td></tr>
                            <tr><td>Email :</td><td><input type="text" name="email" value="${requestScope.object.email}"></td></tr>
                            <tr><td>Phone :</td><td><input type="text" name="phone" value="${requestScope.object.phone}"></td></tr>
                        </table>
