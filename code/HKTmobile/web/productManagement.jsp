...
<html lang="en">
                                ...
                                <div class="store-sort">
                                    <label>
                                        ...
                                        <select name="sortBy" class="input-select">
                                            ...
                                            <option value="BrandID" ${SortBy != null && SortBy.equals("Discount") ? 'selected' : ''}>Brand</option>
                                        </select>
                                    </label>
                                    <label>
                                        Sort Type:
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                ...
                                                <h3>Has found ${totalProducts != null && !totalProducts.equals('') ? totalProducts : '0'} products</h3>
                                        ...
                                        <div class="product product-store">
                                            ...
                                            <div class="product-body store-body">
                                                ...
                                                <h3 class="product-name" style="height: 50px;">
                                                    <a href="./ProductGroup?action=Product&&id=${productGroup.products[0].productID}">${productGroup.productName}</a>
                                                </h3>
                                                <form action="./ProductGroup" method="POST" class="product-form">
                                                    <input type="hidden" name="id" value="${productGroup.products[0].productID}">
                                                    <input type="hidden" name="groupID" value="${productGroup.groupID}">
                                                    <input type="submit" name="action" value="Detail" style="background-color: #D10024; color: white; border: none; padding: 10px; margin: 5px 0; cursor: pointer; font-size: 16px; border-radius: 5px;">
                                                    <input type="submit" name="action" value="Product" style="background-color: #D10024; color: white; border: none; padding: 10px; margin: 5px 0; cursor: pointer; font-size: 16px; border-radius: 5px;">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="js/adminPagination.js"></script>
